...
| Path | `Samples/07_Testing/04_HistoryConsole/04_Testing.HistoryConsole_fromsrc.csproj` |
...
```mermaid
graph TD
    04_Testing_HistoryConsole_fromsrc["<strong>04_Testing.HistoryConsole_fromsrc</strong>"]
    Algo["Algo"]
