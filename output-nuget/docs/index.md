...
### Application (4)
- [NuGet.CommandLine](applications/NuGet.CommandLine.md)
- [NuGet.CommandLine.XPlat](applications/NuGet.CommandLine.XPlat.md)
- [ensure-nupkg-dependencies-on-source](applications/ensure-nupkg-dependencies-on-source.md)
- [ship-public-apis](applications/ship-public-apis.md)

### Library (29)
- [NuGet.MSSigning.Extensions](libraries/NuGet.MSSigning.Extensions.md)
- [NuGet.Indexing](libraries/NuGet.Indexing.md)
- [NuGet.VisualStudio.Internal.Contracts](libraries/NuGet.VisualStudio.Internal.Contracts.md)
- [NuGet.VisualStudio.Contracts](libraries/NuGet.VisualStudio.Contracts.md)
- [NuGet.PackageManagement.VisualStudio](libraries/NuGet.PackageManagement.VisualStudio.md)
- [NuGet.SolutionRestoreManager](libraries/NuGet.SolutionRestoreManager.md)
- [NuGet.PackageManagement.UI](libraries/NuGet.PackageManagement.UI.md)
- [NuGet.VisualStudio](libraries/NuGet.VisualStudio.md)
- [NuGet.VisualStudio.Implementation](libraries/NuGet.VisualStudio.Implementation.md)
- [NuGet.VisualStudio.Common](libraries/NuGet.VisualStudio.Common.md)
- [NuGet.VisualStudio.Interop](libraries/NuGet.VisualStudio.Interop.md)
- [NuGet.PackageManagement.PowerShellCmdlets](libraries/NuGet.PackageManagement.PowerShellCmdlets.md)
- [NuGet.PackageManagement](libraries/NuGet.PackageManagement.md)
- [NuGet.DependencyResolver.Core](libraries/NuGet.DependencyResolver.Core.md)
- [NuGet.Credentials](libraries/NuGet.Credentials.md)
- [NuGet.Resolver](libraries/NuGet.Resolver.md)
- [NuGet.Commands](libraries/NuGet.Commands.md)
- [NuGet.ProjectModel](libraries/NuGet.ProjectModel.md)
- [NuGet.Packaging](libraries/NuGet.Packaging.md)
- [NuGet.Frameworks](libraries/NuGet.Frameworks.md)
- ... +9 more

### Localization (1)
- [NuGet.Localization](applications/NuGet.Localization.md)

### Test (76)
- [UAPApp](applications/UAPApp.md)
- [ClassLibrary1](applications/ClassLibrary1.md)
- [WebApplication](applications/WebApplication.md)
- [BuildIntegratedClassLibrary](applications/BuildIntegratedClassLibrary.md)
- [EmptyMvcApplication](applications/EmptyMvcApplication.md)
- [WebApplication](applications/WebApplication.md)
- [ConsoleApp](applications/ConsoleApp.md)
- [ConsoleApp](applications/ConsoleApp.md)
- [ClassLibrary47](applications/ClassLibrary47.md)
- [WPFApplication](applications/WPFApplication.md)
- [ConsoleApp10](applications/ConsoleApp10.md)
- [ClassLibrary1](applications/ClassLibrary1.md)
- [ConsoleApp](applications/ConsoleApp.md)
- [WebApplication](applications/WebApplication.md)
- [classlibrary](applications/classlibrary.md)
- [consoleapplication](applications/consoleapplication.md)
- [ClassLibrary6](applications/ClassLibrary6.md)
- [BuildIntegratedProj](applications/BuildIntegratedProj.md)
- [classlibrary](applications/classlibrary.md)
- [Dotnet.Integration.Test](applications/Dotnet.Integration.Test.md)
- ... +56 more

### Tool (5)
- [NuGet.VisualStudio.Client](applications/NuGet.VisualStudio.Client.md)
- [NuGet.Console](applications/NuGet.Console.md)
- [NuGet.Tools](applications/NuGet.Tools.md)
- [NuGet.Build.Tasks.Console](applications/NuGet.Build.Tasks.Console.md)
- [Tools](applications/Tools.md)
