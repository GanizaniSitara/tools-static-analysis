...
- Run the full pipeline: `1_scan_projects.py` → `2_scan_smells.py` → `3_external_tools.py` → `4_gen_diagrams.py` → `5_gen_docs.py`
...
## Project Overview
- Static analysis tool for .NET solutions: `1_scan_projects.py` → `2_scan_smells.py` → `3_external_tools.py` → `4_gen_diagrams.py` → `5_gen_docs.py`
...
- `3_external_tools.py`: Runs optional external tools (semgrep, bandit, detect-secrets, radon) for extended analysis
- `4_gen_diagrams.py`: Generates Mermaid (.mmd) and GraphViz (.dot) diagrams from graph.json
- `5_gen_docs.py`: Generates markdown docs, `viewer.html` (interactive HTML viewer), and AI context files
